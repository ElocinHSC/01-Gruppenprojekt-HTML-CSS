...
building, who uses it, what "done" looks like, and what each of you thought the
trickiest requirement meant. Ask that last one out loud, one at a time, before
anyone hears the others; it is the question that finds the split assumption while
it is still cheap.
